...
class ApplicationMain {
	...
	public static function main () {
		...
		flash.Lib.setPackage ("HaxeFlixel", "Stickvania", "com.example.myapp", "0.0.1");
		...
		telemetryConfig.app_name = "Stickvania";
		#end
...
class ApplicationMain {
	...
	public static function main () {
		...
		wx.App.boot (function () {
			...
			frame = wx.Frame.create (null, null, "Stickvania", null, { width: 512, height: 480 });
